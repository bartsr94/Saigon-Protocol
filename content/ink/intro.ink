...
The squad car pulls out of Cholon's press of noodle-stall steam and shopfront signage, three scripts deep on every storefront, and noses south toward District 4. # background: cholonMarket
{ root >= 3:
...
== arrival ==
The lab itself is nothing to look at — a low prefab bolted to the inside of the flood wall, no logo on the door, two SEZAC cruisers already parked outside with their lights off. # background: avelineLabExterior
