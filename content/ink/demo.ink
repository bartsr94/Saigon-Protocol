...
// gating, a Red check via roll_check/is_red_check_consumed, and a
// damage_composure EXTERNAL on the fail branch.
...
{muscle_memory >= 3: Muscle Memory clocks the drone's blind spot before you've finished the thought.|You don't know this model. You don't like that.}
