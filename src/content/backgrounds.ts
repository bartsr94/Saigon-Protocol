...
export type BackgroundId = 'avelineLabExterior' | 'cholonMarket' | 'cholonClinic' | 'district4FloodWall' | 'turtleLakePlaza' | 'pasteurStreetTaproom' | 'tuXuongClinic' | 'undercanopy'
