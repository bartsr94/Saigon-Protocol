...
export const LOCATIONS: Record<LocationId, LocationDefinition> = {
  checkpoint: {
    ...
    name: 'SEZ Checkpoint',
    blurb: 'The border crossing into the corporate core, at the dead end of Khánh Hội Causeway — mask seal checked, ration chit scanned, badge last, all under a recruitment screen looping lunar wage figures at the queue. Where every case starts.',
  ...
  workerCanteen: {
    ...
    districtId: 'district4',
    name: 'Quán Bà Châu',
    blurb: 'Bà Châu\'s counter, a few doors down Khánh Hội Causeway from Aveline — Xóm Chàm\'s canteen, halal by default, run by an old stevedore who traded the wharf for a ladle and still feeds half the district\'s hands and hardware.',
    unlockedByDefault: true,
  ...
  pasteurStreetTaproom: {
    ...
    blurb: 'A villa ground floor turned taproom, hand-brewed and human-run — the respectable face of the Canopy\'s nightlife, with the upstairs rooms and back-stair deals politely left out of the menu.',
    unlockedByDefault: true,
    ambienceIds: ['marketChatter'],
  },
  tuXuongClinic: {
  ...
  undercanopy: {
    ...
    blurb: 'An alley door, a flight of stairs down, and a bar that\'s a front as often as it\'s actually a bar — sublets, narco-runners, anti-rejection meds, cooled organ cases, and anyone desperate enough to broker themselves all pass through the same back booth here.',
    unlockedByDefault: true,
    ambienceIds: ['rain'],
  },
}
