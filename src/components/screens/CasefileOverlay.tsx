...
export function CasefileOverlay() {
  ...
  const evidencePage = usePagination(ownedEvidenceIds, EVIDENCE_PAGE_SIZE)
  const notesPage = usePagination(unlockedNoteIds, NOTES_PAGE_SIZE)
  ...
  return (
    <Panel size="lg" className="flex w-full max-w-4xl flex-col gap-4 p-6" onClick={(e) => e.stopPropagation()}>
