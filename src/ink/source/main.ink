...
Drone traffic hums overhead, light for a Tuesday. Three ways out of this walkway if it goes bad. # voice:dexterity
...
Something about the way they're standing reads as trained, not comfortable. # voice:intellect

* [Read the figure's stance before you move (CHECK Streetwise 8)]
    { lastCheckSuccess:
        -> recognize_contact
    - else:
        -> tense_approach
...
Whatever this turns into, you can take it. # voice:endurance
