...
- **Saigon SEZ after dark** — the city still performs normalcy at night because it has to. The restaurants fill, the bars stay open, live music still plays under the trees and under the flood wall. But the same nightlife is also where a lot of the zone's desperation goes to earn rent: rooms let by the hour, chemistry sold by the dose, couriers moving cooled cases nobody asks about, and clinics quietly handling whatever the official system has priced out. The downturn should feel visible in the leisure economy itself, not cordoned off into some separate "criminal underworld."
